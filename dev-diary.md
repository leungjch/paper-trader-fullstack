...
I've played around a bit with the RapidAPI Yahoo Finance API. I created a helper function to extract the useful data that I want to show the user and store into Postgres. I'm testing the build on Heroku now. I still need to implement inserting the trade into Postgres, and also implementing `SellPage`. After that, I can 